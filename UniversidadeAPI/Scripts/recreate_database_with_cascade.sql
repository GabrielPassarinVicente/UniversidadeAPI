...
-- Inserir Usuários (senha: admin123 - hash SHA256)
INSERT INTO Usuario (Username, PasswordHash, Email, DataCriacao, Ativo) VALUES
('admin', 'jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg=', 'admin@universidade.com', NOW(), TRUE),
('professor1', 'jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg=', 'professor@universidade.com', NOW(), TRUE),
('aluno1', 'jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg=', 'aluno@universidade.com', NOW(), TRUE);
...
-- =====================================================
-- 8. INFORMAÇÕES DOS USUÁRIOS CRIADOS
-- =====================================================

SELECT '?? USUÁRIOS CRIADOS PARA LOGIN' AS Info;
SELECT 
    Id,
    Username,
    Email,
...
?? USUÁRIOS PARA LOGIN:
   Username: admin      | Senha: admin123 | Email: admin@universidade.com
   Username: professor1 | Senha: admin123 | Email: professor@universidade.com
   Username: aluno1     | Senha: admin123 | Email: aluno@universidade.com
*/
