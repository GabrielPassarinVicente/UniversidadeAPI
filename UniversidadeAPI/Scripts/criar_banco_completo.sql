...
-- Senhas: admin=Admin@123, aluno1=Aluno@123, professor1=Prof@123
-- Hash gerado com SHA256 (conforme AuthService.cs)
INSERT INTO Usuario (Username, PasswordHash, Email, DataCriacao) VALUES
('admin', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', 'admin@universidade.com', NOW()),
('aluno1', 'WZRHGrsBESr8wYFZ9sx0tPURuZgG2lmzyvWpwXPKz8U=', 'aluno1@universidade.com', NOW()),
('professor1', '5sYG7Tnn5cRGdTGhzFX1RJEhhZPhQkj8h0Y8gy7y5Ws=', 'professor1@universidade.com', NOW());
